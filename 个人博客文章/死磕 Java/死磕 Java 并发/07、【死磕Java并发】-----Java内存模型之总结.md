...
1. 周志明：深入理解Java虚拟机-第五部分 高效并发
2. [Java 并发编程：volatile的使用及其原理](http://www.cnblogs.com/paddix/p/5428507.html)
3. [Java并发编程：volatile关键字解析](http://www.cnblogs.com/dolphin0520/p/3920373.html)
4. [聊聊高并发（三十三）Java内存模型那些事（一）从一致性(Consistency)的角度理解Java内存模型](http://blog.csdn.net/iter_zc/article/details/41943387)
5. [聊聊高并发（三十四）Java内存模型那些事（二）理解CPU高速缓存的工作原理](http://blog.csdn.net/iter_zc/article/details/41979189)
6. [聊聊高并发（三十五）Java内存模型那些事（三）理解内存屏障](http://blog.csdn.net/iter_zc/article/details/42006811)
7. [聊聊高并发（三十六）Java内存模型那些事（四）理解Happens-before规则](http://blog.csdn.net/iter_zc/article/details/42026511)
8. [happens-before俗解](http://ifeve.com/easy-happens-before/)
