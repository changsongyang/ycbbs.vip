...
Author: penglei penglei@ycbbs.cn
...
如果你要指定日期，可以执行几个选项：`--since` 和 `--before`，但是你也可以用 `--unti`l 和 `--after`。
...
更多 `git` `log` 命令可查看： [http://git-scm.com/docs/git-log][http_git-scm.com_docs_git-log]


[http_git-scm.com_docs_git-log]: http://git-scm.com/docs/git-log
